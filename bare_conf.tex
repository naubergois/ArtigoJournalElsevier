...
\IEEEpubid{\makebox[\columnwidth]{978-1-5090-1633-4/16/\$31.00~
\copyright2016
...
\begin{lstlisting}[style=outline,caption={TabuSearch class},float,label=tabusearchclass]
...
!\colorbox{light-gray}{new MatrixInt}!		if (TabuSearch.getTabuExpires() > expiresCriteria)     
		{
...
\begin{lstlisting}[style=outline,caption={Simulated Annealing Implementation},float,label=saclass]
